...
function ResetPassword() {
  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      {/* LEFT */}
      <div className="w-full md:w-1/2 bg-[#e6f4f1] flex flex-col justify-between px-4 md:px-10 py-6 md:py-8 text-center">
      ...
      <div className="hidden md:flex w-1/2 items-center justify-center bg-gray-50 px-8">
        <div className="text-center max-w-sm">
          <h3 className="text-xl font-bold mb-3">Strong Password</h3>
          <p className="text-gray-500">
            Use at least 8 characters and a number.
          </p>
        </div>
      </div>
