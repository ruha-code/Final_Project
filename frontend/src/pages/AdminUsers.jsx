    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white w-[480px] rounded-2xl shadow-xl overflow-hidden">
        <div className="flex justify-between items-center px-6 py-4 bg-teal-50 border-b">
          <h2 className="font-semibold">Create {role === "ADMIN" ? "Admin" : "Doctor"} Account</h2>
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            ...
            >
              {loading ? "Creating..." : `Create ${role === "ADMIN" ? "Admin" : "Doctor"}`}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3 items-center">
          <form onSubmit={handleSearch} className="flex gap-2">
            ...
            <button type="submit" className="px-4 py-2 bg-gray-100 rounded-xl text-sm hover:bg-gray-200">
              Search
            </button>
          </form>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border shadow-sm overflow-hidden">
            ...
            {users.length === 0 ? (
              ...
              users.map((u) => (
                <div key={u.id} className="grid grid-cols-6 px-6 py-4 items-center border-b last:border-none hover:bg-gray-50">
                  ...
                  <span className={`text-xs px-2.5 py-1 rounded-md font-medium w-fit ${ROLE_STYLES[u.role] || "bg-gray-100 text-gray-500"}`}>
                    {u.role}
                  </span>

                  <span className={`text-xs px-2.5 py-1 rounded-md font-medium w-fit ${u.is_active ? "bg-green-50 text-green-600" : "bg-red-50 text-red-500"}`}>
